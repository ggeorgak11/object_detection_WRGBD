...
function [support_surfaces, surface_eq, large_planes, merged_plane_labels, plane_eq] = get_support_surface(RGB, depth, params)
...
[merged_plane_labels, ~] = mxFindPlanes (W, uint32(labels2), focal_length, min_points, ransac_trials, inlier_threshold, ...
...
% f1=figure; if ~params.figs_visible, set(gcf,'Visible', 'off'); end
